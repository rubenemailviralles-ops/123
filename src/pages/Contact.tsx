          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-white text-black hover:bg-gray-100 px-6 py-4 rounded-lg font-semibold text-base transition-all duration-300 hover-pop-button flex items-center justify-center shadow-lg"
                >
